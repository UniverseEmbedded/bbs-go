  ...
  <div class="container">
    <div class="container-header">
      <a-form :model="filters" layout="inline" :size="appStore.table.size">
        ...
        <a-form-item>
          <a-input-number v-model="filters.taskId" placeholder="TaskId" :min="0" />
        </a-form-item>
        <a-form-item>
    ...
    <div class="container-main">
      ...
      >
        <template #columns>
          ...
          <a-table-column title="PeriodKey" data-index="periodKey" />
          <a-table-column title="TaskId" data-index="taskId" />
          <a-table-column title="FinishNo" data-index="finishNo" />
