    ...
    <div class="container-main">
      ...
      >
        <template #columns>
          ...
          <a-table-column title="DayName" data-index="dayName" />
          <a-table-column title="ConsecutiveDays" data-index="consecutiveDays" />
          <a-table-column title="CreateTime" data-index="createTime">
            <template #cell="{ record }">
              {{ record.createTime ? useFormatDate(record.createTime) : '-' }}
            </template>
          </a-table-column>
          <a-table-column title="UpdateTime" data-index="updateTime">
            <template #cell="{ record }">
