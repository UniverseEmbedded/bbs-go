  ...
  <div class="container">
    <div class="container-header">
      <a-form :model="filters" layout="inline" :size="appStore.table.size">
        <a-form-item>
          <a-input-number v-model="filters.id" placeholder="ID" :min="0" />
        </a-form-item>
        <a-form-item>
    ...
    <div class="container-main">
      ...
      >
        <template #columns>
          ...
          <a-table-column title="ThirdType" data-index="thirdType" />
          <a-table-column title="OpenId" data-index="openId" />
          <a-table-column title="Nickname" data-index="nickname" />
