  ...
  <div class="container">
    <div class="container-header">
      <a-form :model="filters" layout="inline" :size="appStore.table.size">
        <a-form-item>
          <a-input-number v-model="filters.id" placeholder="RecordId" :min="0" />
        </a-form-item>
        <a-form-item>
    ...
    <div class="container-main">
      ...
      >
        <template #columns>
          ...
          <a-table-column title="VoteId" data-index="voteId" />
          <a-table-column title="OptionIds" data-index="optionIds" />
