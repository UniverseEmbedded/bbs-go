    ...
    <div class="container-main">
      ...
      >
        <template #columns>
          ...
          <a-table-column title="Badge" data-index="badgeId">
            <template #cell="{ record }">
              <span>{{ record.badgeId }}</span>
              <a-image
                v-if="record.icon"
                :src="record.icon"
                :width="20"
          ...
          <a-table-column title="IsWorn" data-index="isWorn" />
...
<script setup lang="ts">
  ...
  const filters = reactive({
    ...
    badgeId: undefined as number | undefined,
